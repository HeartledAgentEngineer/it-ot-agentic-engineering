...
| **typeFREE** (Diktier-Tool) | Python, OpenAI Whisper (`whisper-1`), Groq (`llama-3.1-8b-instant`), globale Keyboard-Hooks, System-Tray, pytest | Produktiv im täglichen Eigeneinsatz (Windows); 62 automatisierte Prüfungen; mitlaufende Kostenrechnung im Tray; Android-Companion eingestellt (siehe unten) | [README](typeFREE/README.md) |
