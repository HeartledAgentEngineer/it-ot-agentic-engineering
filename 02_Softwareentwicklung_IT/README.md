...
| **typeFREE** (Diktier-Tool) | Python, OpenAI Whisper (`whisper-1`, direkt + OpenRouter-Fallback), OpenRouter/Gemini 2.5 Flash (Textglättung), globale Keyboard-Hooks, System-Tray, pytest | Produktiv im täglichen Eigeneinsatz (Windows); 84 automatisierte Prüfungen; Installer-Paket für Weitergabe; mitlaufende Kostenrechnung im Tray; Android-Companion eingestellt (siehe unten) | [README](typeFREE/README.md) |
...
flowchart LR
    ...
    PAA -->|Chat & Modell (OpenRouter)| DeepSeek
