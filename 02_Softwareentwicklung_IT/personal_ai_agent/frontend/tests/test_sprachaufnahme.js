...
pruefe('index.html lädt app.js mit ?v=20260925E',
  /app\.js\?v=20260925E/.test(html), 'Cache-Bump fehlt');
pruefe('index.html lädt style.css mit ?v=20260925D',
  /style\.css\?v=20260925D/.test(html), 'Cache-Bump für style.css fehlt');
